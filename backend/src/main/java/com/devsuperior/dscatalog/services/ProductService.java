...
public class ProductService {
	...
	public Page<ProductDTO> findAllPaged(PageRequest pageRequest) { // findAll é o nome do método, pode ser qlq um.
		Page<Product> list = repository.findAll(pageRequest);// acessa o repository e chama as categorias do BD, coloca
																// na
	...
	public void delete(Long id) {
		...
		} catch (DataIntegrityViolationException e) {// para garantir a integridade do BD (Não deletar o que não pode
														// ser deletado)
	...
	private void copyDtoToEntity(ProductDTO dto, Product entity) {
		...
		entity.setDescription(dto.getDescription());//produto
		entity.setDate(dto.getDate());
		entity.setImgUrl(dto.getImgUrl());
		entity.setPrice(dto.getPrice());
		
		entity.getCategories().clear();//limpa se tiver carregado
